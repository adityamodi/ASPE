...
% derivative of likelihood on the parameters
	...
	lik_der(1:m0) = sum( p0 * log_der_unlab0 )' + sum( bsxfun(@times,1./neg_lik0,neg_lik_der0) )' + ...
	...
	lik_der(m0+1:m1+m0) = sum( p1 * log_der_unlab1 )' + sum( bsxfun(@times,1./pos_lik1,pos_lik_der1) )' + ...
